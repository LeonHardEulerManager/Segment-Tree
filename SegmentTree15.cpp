...
// Đề bài: https://codeforces.com/edu/course/2/lesson/4/2/practice/contest/273278/problem/A
// Dùng Segment Tree để query tổng đoạn con lớn nhất

struct Node {
    int prefix;
    int suffix;
    int largest; // tổng đoạn lớn nhất
    int sum;
...
void update(int idx, int left, int right, int pos, int val) {
    ...
    if(left == right) {
        ...
        SegmentTree[idx].largest = max(0LL, val);
